...
There was a significant main effect of colour, t(2145) = 2.1, p = 0.0356, no other main effects were found to be significant.

An interaction effect of the colour compared to the colour frequency was found to be significant t(2145) = -2.62, p = 0,0090. 


When a higher significant effect is present, there is no reason to interpret the main effect of colour. To interpret the interaction effect we will make a line plot of it: 
